		...
		<div class="scrollable">
			<table style="width: 700px; float: right">
				...
				<tr>
					...
					<td><a href="viewcontent.jsp?id=<%=rs.getString("id")%>">View
							File</a></td>
			...
			<nav>
				...
				<li>
					<ul>
						...
						<li><a href="files.jsp">Public Domain</a></li>
						<li><a href="files1.jsp">Private Domain</a></li>
