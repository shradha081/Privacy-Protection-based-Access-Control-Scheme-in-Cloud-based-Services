...
<head>
<title>Cloud_Based-Services</title>
<meta charset="utf-8">
      ...
      <div>
        ...
        <form action="oreg1.jsp" method="get" enctype="multipart/form-data">
          ...
          <div class="one_third">
            ...
            <input style="width: 250px;height: 35px;" type="text" name="email" id="email" value=""  required>
          </div>
          <div class="one_third">
         ...
         <div class="one_third">
           <label for="date">Date<span>*</span></label>   
            <input style="width: 250px;height: 35px;" name="date" type="date"  placeholder="Enter Date" required=""/><br><br>  
          </div>
